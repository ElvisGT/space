                ...
                {data_popular !== undefined &&
                    data_popular.map(item => (
                        <article key={item.id} className='sections-card'>
                            <img className='sections-card-img' src={domain_img + item.poster_path} alt={item.original_title}/>
                            <p className='sections-card-title'>Titulo: {item.original_title}</p>
                            <p className='sections-card-description'>Descripcion: {item.overview}</p>
                            <p >Valoracion: <span className='sections-card-valoration'>{item.vote_average}</span></p>
                            <p className='sections-card-release'>Fecha de salida: {item.release_date}</p>
                        </article>
                    ))
                }
            </div>
